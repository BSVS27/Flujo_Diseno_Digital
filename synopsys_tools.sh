...
# Revision:     20/03/2018                                                              
#		
#		(ACR).	Se actualiza ICC, DC, PrimeTime, MilkyWay
...
SNPSLMD_LICENSE_FILE=27000@172.21.9.209,27000@172.21.9.210,27000@172.21.9.211; # de la licencia se encuentra en esta direccion
